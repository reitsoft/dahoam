	...
	<div class="flex shrink-0 items-center justify-between px-5 pt-5 pb-1">
		<div class="flex items-center gap-2">
			{#if ansicht === 'tag'}
				...
				<span class="text-xs font-semibold text-cream-100/70">Stundenplan · {heutigesLabel}</span>
			{:else}
			...
			{#if heute}
				<div class="flex flex-1 flex-col justify-around gap-1">
					{#each STUNDENPLAN[heute] as stunde}
						...
						<div
							class="flex shrink-0 items-center gap-3 rounded-2xl px-3 py-2.5 {aktiv
						...
						>
							...
							<div class="flex flex-1 flex-col">
								...
								{#if stunde.raum || stunde.lehrer}
									<span class="text-[11px] text-cream-100/40">
